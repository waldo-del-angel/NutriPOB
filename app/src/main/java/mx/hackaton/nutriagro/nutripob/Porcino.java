...
public class Porcino extends AppCompatActivity {
    ...
    //Eje X
    private String[]alimentos=new String[]{"Sorgo","Trigo","Arroz","Hominy","Algodón","Soya proc."};
    //Eje Y
    private int[]porcentaje=new int[]{70,12,10,40,8,18};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        barChart=(BarChart)findViewById(R.id.barChart_porcino);
        createChar();
    }
