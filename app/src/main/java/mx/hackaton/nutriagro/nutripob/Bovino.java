...
public class Bovino extends AppCompatActivity {

    private BarChart barChart;
    //Eje X
    private String[]alimentos=new String[]{"Proteína mín.","Grasa mín.","Fibra máx.", "Cenizas máx.", "Humedad máx."};
    //Eje Y
    private int[]porcentaje=new int[]{16,3,7,9,13};

    //Colores
    private int[]colors=new int[]{Color.rgb(0,230,118), Color.rgb(0,229,255),
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bobino);
        barChart = (BarChart)findViewById(R.id.barChart_bovino);
        createChar();
    }
